...
int main(int argc, char *argv[]) {
  ...
  auto first_part = std::chrono::duration_cast<std::chrono::milliseconds>(middle - start);
  auto second_part = std::chrono::duration_cast<std::chrono::milliseconds>(end - middle);
  auto complete = std::chrono::duration_cast<std::chrono::milliseconds>(end - start);

  std::cout << "Timing: " << first_part.count() << "\t+ " << second_part.count() << "\t= " << complete.count() << "\n";
